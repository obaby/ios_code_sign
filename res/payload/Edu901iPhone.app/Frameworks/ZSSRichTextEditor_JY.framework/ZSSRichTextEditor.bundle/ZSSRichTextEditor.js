...
zss_editor.setPlaceholder = function(placeholder) {
    ...
    if(editor.text().length == 0){
        ...
        editor.css("color","#333740");
    }
    //set focus
    editor.focus(function(){
                 if($(this).text() == placeholder){
                     $(this).text("");
                     $(this).css("color","#333740");
                     }
                     var iframe = document.getElementById("zss_editor_blank");
                     iframe.src = 'focus://';
                 }).focusout(function(){
                             if(!$(this).html().length){
...
zss_editor.deleteEmoji = function(html) {

    var reg = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g;
    var parent = document.getElementById("zss_editor_content");
    ...
    loopChildren(parent, function(node){
